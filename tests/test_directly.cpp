...
main()
{
	...
	std::cout << "[section 0] key_0 = " << _manager.GetValue(_file, 1, "section 0", "key_0") << std::endl;
	std::cout << "[section 0] key_1 = " <<_manager.GetValue(_file, 10, "section 0", "key_1") << std::endl;
	std::cout << "[section 1] key = " <<_manager.GetValue(_file, 100, "section 1", "key") << std::endl;
	std::cout << "[section 2] key = " <<_manager.GetValue(_file, 1000, "section 2", "key") << std::endl;
